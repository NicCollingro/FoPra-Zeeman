...
errorbar(peakposkorr(:,1),peakposkorr(:,2),peakposkorr(:,6),peakposkorr(:,6),DeltaB,DeltaB,"LineStyle","none","LineWidth", 1.8, "Color", "Black")

errorbar(peakposkorr(:,1),peakposkorr(:,3),peakposkorr(:,7),peakposkorr(:,7),DeltaB,DeltaB,"LineStyle","none","LineWidth", 1.8, "Color", "Black")
errorbar(peakposkorr(:,1),peakposkorr(:,4),peakposkorr(:,8),peakposkorr(:,8),DeltaB,DeltaB,"LineStyle","none","LineWidth", 1.8, "Color", "Black")
errorbar(peakposkorr(:,1),peakposkorr(:,5),peakposkorr(:,9),peakposkorr(:,9),DeltaB,DeltaB,"LineStyle","none","LineWidth", 1.8, "Color", "Black")
hold off
